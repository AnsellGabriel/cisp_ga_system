...
class GeoMunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geo_municipality" do
    assert_difference("GeoMunicipality.count") do
      post geo_municipalities_url, params: { geo_municipality: { geo_province_id: @geo_municipality.geo_province_id, geo_region_id: @geo_municipality.geo_region_id, name: @geo_municipality.name } }
    end
  ...
  test "should update geo_municipality" do
    patch geo_municipality_url(@geo_municipality), params: { geo_municipality: { geo_province_id: @geo_municipality.geo_province_id, geo_region_id: @geo_municipality.geo_region_id, name: @geo_municipality.name } }
