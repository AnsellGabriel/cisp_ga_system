...
class GeoBarangaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geo_barangay" do
    assert_difference("GeoBarangay.count") do
      post geo_barangays_url, params: { geo_barangay: { geo_municipality_id: @geo_barangay.geo_municipality_id, geo_province_id: @geo_barangay.geo_province_id, geo_region_id: @geo_barangay.geo_region_id, name: @geo_barangay.name } }
    end
  ...
  test "should update geo_barangay" do
    patch geo_barangay_url(@geo_barangay), params: { geo_barangay: { geo_municipality_id: @geo_barangay.geo_municipality_id, geo_province_id: @geo_barangay.geo_province_id, geo_region_id: @geo_barangay.geo_region_id, name: @geo_barangay.name } }
