...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference("Election.count") do
      post elections_url, params: { election: { event_hub_id: @election.event_hub_id, voter_code: @election.voter_code } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { event_hub_id: @election.event_hub_id, voter_code: @election.voter_code } }
