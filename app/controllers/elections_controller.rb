class ElectionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      if @election.save
        if r == "r"
          format.html { redirect_to new_referendum_response_path(e: @event_hub), notice: "You may now vote" }
        else
          format.html { redirect_to vote_votes_path(e: @event_hub), notice: "Election was successfully created." }
        end
