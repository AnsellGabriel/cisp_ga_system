class CandidatesController < ApplicationController
  ...
  def set_dummy_register
    ...
    @candidate.elect_position = @my_coop_event.elect_positions.sample
    @candidate.coop_event_id = @my_coop_event.id
    @candidate.event_hub = @my_coop_event.event_hubs.sample
